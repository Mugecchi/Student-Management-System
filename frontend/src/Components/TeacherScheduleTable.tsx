					...
					<tr>
						...
						{teachers.map((teacher) => (
							<th
								...
								style={teacher?.color ? { background: teacher.color } : {}}
							>
				...
				<tbody>
					{times.map((time, rowIdx) => (
						<tr key={time}>
							...
							{teachers.map((teacher, colIdx) => {
								const cell = schedule[rowIdx] && schedule[rowIdx][colIdx];
								const hasSchedule = cell && cell.value;
								const bgColor =
									hasSchedule && teacher.color ? teacher.color : undefined;
								return (
									<td
										key={colIdx}
